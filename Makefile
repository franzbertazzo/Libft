...
#    Updated: 2019/10/07 20:12:52 by fbertazz         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #

NAME=libft.a

SRCS = ft_lstmap.c ft_lstiter.c ft_lstadd.c ft_lstdel.c ft_lstdelone.c \
	ft_lstnew.c ft_splitter.c ft_count_words.c ft_count_letters.c \
	ft_strsplit.c ft_itoa.c \
	ft_is_white_space.c ft_intlen.c ft_atoi.c ft_bzero.c ft_isalnum.c \
	ft_isalpha.c ft_isascii.c ft_isdigit.c ft_isprint.c \
	ft_memalloc.c ft_memchr.c ft_memccpy.c ft_memcmp.c ft_memcpy.c \
...
OBJECTS = ft_lstmap.o ft_lstiter.o ft_lstadd.o ft_lstdel.o ft_lstdelone.o \
	ft_lstnew.o ft_splitter.o ft_count_words.o ft_count_letters.o \
	ft_strsplit.o ft_itoa.o \
	ft_is_white_space.o ft_intlen.o ft_atoi.o ft_bzero.o ft_isalnum.o \
	ft_isalpha.o ft_isascii.o ft_isdigit.o ft_isprint.o \
	ft_memalloc.o ft_memchr.o ft_memccpy.o ft_memcmp.o ft_memcpy.o \
